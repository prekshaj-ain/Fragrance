  ...
  return (
    <div className={`flex flex-col md:flex-row items-center w-screen h-full ${value?.id === 1 ? 'bg-pink-200' : 'text-[#ffd3c2] bg-[#47342e]'}`}>
      <div className="basis-1/2 h-full">
        <img src={value?.img} alt="" className="h-full w-full" />
      </div>
      <div className="basis-1/2  p-6 flex flex-col items-center justify-center">
        ...
        <p className="text-center">{value?.heading}</p>
